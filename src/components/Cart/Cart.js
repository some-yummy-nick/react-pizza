...
export class Cart extends PureComponent {
    ...
    render() {
        const {items, total, removeFromCart, addQuantity, subQuantity, clearCart} = this.props;
            ...
            {!items.length ?
                ...
                <div className="cart__center">
                    ...
                    <div className="cart__score">
                        <div className="cart__amount">Всего пицц: <strong>{items.reduce((accumulator, item) => accumulator + item.quantity, 0)} шт.</strong></div>
